                    ...
                    <Grid>
                      <Row>
                        <Col xs={12} className='fg-white'>
                          ...
                          <h6>Type in the name or wallet number of any Merchant to search ...</h6>
                        </Col>
                      </Row>
                    </Grid>
                  </PanelHeader>
                            ...
                            <Panel>
                              <PanelBody>
                                <Grid>
                                  <Row>
                                    <Col xs={12}>
                                      <Table id='merchantdt' className='display' cellSpacing='0' width='100%'>
                                        <thead>
                                          <tr>
                                            <th>Account</th>
                                            <th>Name</th>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td><Link to='/app/merchants/details/Tiger Nixon'>Tiger Nixon</Link></td>
                                          ...
                                          <tr>
                                            <td><Link to='/app/merchants/details/Garrett Winters'>Garrett Winters</Link></td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>63</td>
                                            <td>2011/07/25</td>
                                          ...
                                          <tr>
                                            <td><Link to='/app/merchants/details/Ashton Cox'>Ashton Cox</Link></td>
