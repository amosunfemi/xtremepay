    ...
    return (
      <div style={{height: 350, marginTop: -25, backgroundImage: 'url(/imgs/shots/Blick_auf_Manhattan.JPG)', backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
        ...
        <div className='social-desc'>
          <div>
            <h1 className='fg-white'>{this.merchant.address}</h1>
            <h5 className='fg-white' style={{opacity: 0.8}}>- {this.merchant.dateRegistered}</h5>
        ...
        <div className='social-avatar'>
          ...
          <h4 className='fg-white text-center'>{this.merchant.name}</h4>
          <h5 className='fg-white text-center' style={{opacity: 0.8}}>{this.merchant.slogan}</h5>
  ...
  render() {
    ...
    return (
      <Container id='body' className='social'>
        <MerchantDetail accountNo={this.props.accountNo}/>
        <Grid>
          <Row>
  ...
  render() {
    ...
    return (
      <Container id='container' className={classes}>
        <Sidebar />
        <Header />
        <Body accountNo={this.props.params}/>
        <Footer />
      </Container>
    );
  }
